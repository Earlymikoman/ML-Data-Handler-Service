...
using MLDataHandler.DataHandler;

namespace MLDataHandler.Azure;
...
public class CosmosDbWrapper
{
    ...
    public CosmosDbWrapper(IConfiguration configuration)
    {
        ...
        string cosmosEndpoint = configuration["MLDataHandler:ConnectionStrings:CosmosEndpoint"];
        string cosmosConnectionString = configuration["MLDataHandler:ConnectionStrings:CosmosConnectionString"];
        ...
        string databaseName = configuration["MLDataHandler:ConnectionStrings:CosmosDatabaseName"];
        string containerName = configuration["MLDataHandler:ConnectionStrings:CosmosContainerName"];
    ...
    public async Task DeleteItemAsync(string id, string pk)
    {
        ...
        {
            log.SetAttribute("id", id);
            await _container.DeleteItemAsync<DataMetadata>(id, new PartitionKey(pk));
        }
    }
}
