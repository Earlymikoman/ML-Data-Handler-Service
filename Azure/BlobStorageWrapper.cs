...
public class BlobStorageWrapper
{
    ...
    public BlobStorageWrapper(IConfiguration configuration)
    {
        ...
        string blobEndpoint = configuration["MLDataHandler:ConnectionStrings:BlobStorageEndpoint"];
        string blobConnectioonString = configuration["MLDataHandler:ConnectionStrings:BlobStorageConnectionString"];
